...
const pages = [
  ...
  ...['instalacion-de-camaras-de-seguridad', 'timbres-inteligentes', 'cerraduras-digitales', 'automatizacion-residencial'].map((slug) => ({ path: `servicios/${slug}`, priority: '0.9', changefreq: 'monthly' })),
